package com.cic.pas.preMonitor;
...
public class MonitorServiceImpl implements IMonitorService {
    ...
    private double getCpuRatioForWindows() {  
        try {  
            ...
            if (c0 != null && c1 != null) {  
                ...
                if((busytime + idletime)!=0){//change:加个判断除数为0的情况
    ...
    private long[] readCpu(final Process proc) {  
        ...
        try {  
            ...
            long kneltime = 0;  
            long usertime = 0;  
            while ((line = input.readLine()) != null && !(line=input.readLine()).isEmpty() && !(line=input.readLine()).equals("")) { //change:加一个判断为""的情况 
                ...
                String caption = Bytes.substring(line, capidx, cmdidx - 1)  
                        .trim();//这里的substring方法可能会导致Long.valueOf方法的解析异常  
                ...
                kneltime += Long.valueOf(  
                        Bytes.substring(line.trim(), kmtidx, rocidx-1).trim())  
                        .longValue();  
