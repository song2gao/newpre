...
//		Thread.sleep(10000);
	...
	public static void createData(String method, String content) {
		if (method.equals("devices")) {
			...
			JSONObject jobject = JSONObject.parseObject(content);
			JSONArray array = JSONArray.parseArray(jobject.getString("rts"));
			List<RequestData> devices = JSONObject.parseArray(array.toJSONString(),RequestData.class);
